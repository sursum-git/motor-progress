...
COPY-LOB FROM FILE "D:\opencode\motor-progress\examples\customer-pipeline-request.json" TO lcJson.
...
COPY-LOB lcOut TO FILE "D:\opencode\motor-progress\examples\responses\customer-pipeline-client-response.json".
