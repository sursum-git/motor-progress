...
- `sursum-api/rest/DynamicQueryWebHandler.cls`: entrada HTTP WEB do PASOE.
...
- `sursum-api/sursum/DynamicMultiTableQueryService.cls`: orquestracao e execucao sync/async.
