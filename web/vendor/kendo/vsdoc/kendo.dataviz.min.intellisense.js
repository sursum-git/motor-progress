...
intellisense.annotate(instance, {
    ...
    loading: function(value) {
        ...
        /// </summary>
        /// <param name="value" type="Boolean" >The value to set. If true, marks the node as currently loading. If false, marks the node as not loading. If omitted, the method acts as a getter and returns the current loading state.</param>
        /// <returns type="Boolean">—The current loading state of the node when called without parameters. Returns true if the node is currently loading its children, false otherwise.</returns>
        /// </signature>
    },
    parentNode: function() {
        /// <signature>
...
intellisense.annotate(instance, {
    addStop: function(offset,color,opacity) {
        ...
        /// <param name="color" type="String" >The color in any of the following formats.| Format | Description | | :--- | ---: | | red | Basic or Extended CSS Color name | | #ff0000 | Hex RGB value | | rgb(255, 0, 0) | RGB value |Specifying 'none', 'transparent' or '' (empty string) will clear the fill.</param>
