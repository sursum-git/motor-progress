var sidebar = {
    ...
    collapse: function(anchor) {
        if (!anchor.hasClass("kd-group-link") || (anchor.hasClass("kd-group-link") && !anchor.hasClass("kd-link-bolded"))) {
            anchor = anchor.closest("ul").siblings(".kd-group-link").first();
        ...
        el.on("keydown", "a", function(e) {
            ...
            if (key == keys.DOWN) {
                ...
                if (!isExpanded) {
                    ...
                    if (list.length) {
                        list.find("a").first().trigger("focus");
                    }
                }
                e.preventDefault();
            } else if (key == keys.UP) {
                ...
                sidebar.toggleGroup.call(current, e);
            } else if (key === keys.HOME) {
                el.find(".kd-list a.kd-link").first().trigger("focus");
            } else if (key === keys.END) {
                el.find("a.kd-group-link").last().trigger("focus");
            }
        });
    },
    ...
    init: function() {
        ...
        $(".kd-side-nav-toggle").on("click", this.toggle);
        $("a.kd-group-link").on("click", this.toggleGroup);
        this.scrollToWidget();
...
$(document).ready(function() {
    ...
    $(".kd-breadcrumb-nav .active").on("click", function(ev) {
        ev.preventDefault();
    });
});
