...
(function($, undefined) {
    ...
    var DatePicker = Widget.extend({
        ...
        setOptions: function(options) {
            const that = this;
            const value = options.value || that.options.value || that._value;
            ...
            if (value) {
                ...
                that.value(new Date(value));

                if (that.dateView) {
                    that.dateView.value(new Date(value));
                }

                if (that._dateInput) {
                    that._dateInput.value(new Date(value));
                }
            }
