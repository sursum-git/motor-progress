...
```text
D:\opencode\motor-progress\sursum-api\sursum
D:\opencode\motor-progress\sursum-api\rest
D:\opencode\motor-progress\sursum-api\workers
D:\opencode\motor-progress\sursum-api\runners
D:\opencode\motor-progress\sursum-api\sursum\esp
D:\opencode\motor-progress
C:\Progress\OpenEdge\tty\netlib\OpenEdge.Net.pl
```

`D:\opencode\motor-progress` deve permanecer no `PROPATH` porque e a pasta pai de:
...
Os fontes da nova API `IWebHandler` devem referenciar programas com o prefixo `sursum-api/`, e os JSONs operacionais devem ser lidos de `conf-web-handler`.
...
```text
sursum-api/workers/BenchmarkCustomerCountOnServer.p
```
