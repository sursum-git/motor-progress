...
assertContains($page, 'vendor/kendo/examples/content/shared/js/jszip.min.js', 'dependencia JSZip para exportar Excel');
assertContains($page, 'toolbar: ["excel"]', 'botao exportar Excel no grid');
assertContains($page, 'excel:', 'configuracao de exportacao Excel');
assertContains($page, 'allPages: true', 'exportacao Excel considera todos os registros carregados');
assertContains($page, 'sursum-consulta-salva.xlsx', 'nome do arquivo Excel exportado');
