...
&Scoped-Define ENABLED-OBJECTS rt-button RECT-1 fiTextos tgCaseInsensitive ~
...
DEFINE FRAME f-cad
     fiTextos AT ROW 3.5 COL 14.57 COLON-ALIGNED WIDGET-ID 4
     tgCaseInsensitive AT ROW 3.5 COL 77.29 WIDGET-ID 6
     fiExtensoes AT ROW 4.5 COL 14.72 COLON-ALIGNED WIDGET-ID 12
     edDiretorios AT ROW 6.17 COL 16.86 NO-LABEL WIDGET-ID 8
     btExecutar AT ROW 6.54 COL 77.57 WIDGET-ID 14
     "Diret¢rios" VIEW-AS TEXT
          SIZE 8 BY .54 AT ROW 5.5 COL 16.86 WIDGET-ID 10
...
ON CHOOSE OF btExecutar IN FRAME f-cad /* Compilar */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-exihel ).
       RUN set-position IN h_p-exihel ( 1.17 , 82.72 ) NO-ERROR.
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             fiTextos:HANDLE IN FRAME f-cad , 'BEFORE':U ).
    END. /* Page 0 */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE buscarArquivos w-livre 
...
/*FIND FIRST ttEstatistica NO-ERROR.
    MESSAGE 'Inicio:' ttEstatistica.dtHrIni SKIP
            'Fim:' ttEstatistica.dtHrFim SKIP
            'Tempo em Segundos:' ttEstatistica.segundos SKIP
            'Qt.Arquivos Encontrados:' ttEstatistica.qtArquivo
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE compilarArquivos w-livre 
...
------------------------------------------------------------------------------*/
  ...
  ENABLE rt-button RECT-1 fiTextos tgCaseInsensitive fiExtensoes edDiretorios 
         btExecutar 
      WITH FRAME f-cad IN WINDOW w-livre.
