    ...
    if ($action === 'create') {
        ...
        $stmt = $pdo->prepare(
            'INSERT INTO metadata_sync_jobs
             (id, environment_id, company_id, database_name, status, total_tables, include_relations, include_view_as, created_at, updated_at)
             VALUES (:id, :environment_id, :company_id, :database_name, "pending", :total_tables, :include_relations, :include_view_as, :created_at, :updated_at)'
        );
        $stmt->execute([
            ':id' => $id,
