...
&Scoped-Define ENABLED-OBJECTS RECT-1 edmsg bt-ok bt-cancelar bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS edmsg 
...
DEFINE FRAME F-Main
     edmsg AT ROW 1.25 COL 3 NO-LABEL WIDGET-ID 2
...
DO:
  ASSIGN cmd = ' cd t: &&  cd tst/especificos && git commit -a -m  "' + edmsg + '"'.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-1 edmsg bt-ok bt-cancelar bt-ajuda 
      WITH FRAME F-Main IN WINDOW w-window.
